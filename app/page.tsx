        ...
        <Card>
          <CardContent className="p-6">
            ...
            <p className="mb-4 text-justify">
              ...
              Through consistent effort and staying updated with new developments, Nanda has gained skills in clustering, regression, classification, and text analysis.
            ...
            <p className="mb-4 text-justify">
              ...
              Additionally, Nanda worked at a IT Services firm, gaining practical experience in optimizing business processes through data analytics within a team environment.
            </p>
            <p className="mb-4 text-justify">
              ...
              Throughout her experiences, Nanda has developed a strong understanding of problem-solving, data processing, dashboard creation, model building, evaluation, and deployment.
            </p>
            <p className="mb-4 text-justify">
              Nanda maintains a blog where she shares her learning experiences.
              Her current areas of interest include MLOps, Generative AI, Supply Chain Analytics, and puts special attention to Diversity, Equity, and Inclusion (DEI) issues. Nanda is actively seeking opportunities in the Data and AI field.
